...
class Material extends Controller
{
    ...
    public function actualizar($dados): void
    {
        ...
        if ($dados["tipo"] === "ata") {
            ...
            $tipoMaterial = (new Ata())->find("id_material = :idm", "idm={$dados["id"]}");
            $tipoMaterial->nome_congresso = $dados["categoria"];
            ...
            $tipoMaterial = (new Livro())->find("id_material = :idm", "idm={$dados["id"]}");
            $tipoMaterial->id_genero = $idCat;
            ...
            $tipoMaterial = (new Revista())->find("id_material = :idm", "idm={$dados["id"]}");
            $tipoMaterial->id_frequencia_publicacao = $idCat;
        ...
        $material->editoral = $dados["editoral"];
        ...
        echo $this->ajaxResponse("message", [
            "type" => "success",
            "message" => "Material actualizado com sucesso"
        ]);
    }
